...
MOTION_CURVE = [40, 16.74]              # 加了罩子
SAFE_DISTANCE_Z = 45            # 保证运动不会碰到药盒
...
def do(box_matrix, num):
    ...
    safe_distance_z = SAFE_DISTANCE_Z
    ...
    # 2.2 z轴
    # 目标：盒子打开口子边缘z坐标 + 掉落轨迹z方向长度 + 安全高度
    target_z = box_origin_coordinates[2] + motion_curve[1] + safe_distance_z
    # 2.3 根据计算运动xz轴
